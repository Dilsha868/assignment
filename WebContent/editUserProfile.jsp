	...
	<div class="content-wrapper">
		<div class="container">
			...
			<div class="row">
				...
				ResultSet resultSet = statement.executeQuery("select * from users where id='" + session.getAttribute("uid")
							...
							<form action="UserProfileUpdate" method="post">
								...
								<div class="form-group">
									<label>Student Name:</label> <input type="text" name="Name"
										class="form-control" value="<%=resultSet.getString(2)%>" required>
								</div>

								<div class="form-group">
									<label>Email Id:</label> <input type="text" name="email"
										class="form-control" value="<%=resultSet.getString(3)%>" required>
								</div>
								<div class="form-group">
									<label>Address:</label>
									<textarea name="address" class="form-control" required><%=resultSet.getString(4)%></textarea>
								</div>
								<div class="form-group">
									<label>State:</label> <input type="text" name="state"
										class="form-control" value="<%=resultSet.getString(5)%>" required>
								</div>
								<div class="form-group">
									<label>User Name:</label> <input type="text" name="uname"
										class="form-control" value="<%=resultSet.getString(6)%>" readonly>
								</div>
